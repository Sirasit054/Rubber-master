 ...
 * @author Home
 */
public class report_scraps extends javax.swing.JFrame {
DefaultTableModel model=new DefaultTableModel();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("หมายเลขการขาย");

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
        jLabel3.setText("รายงานการขายยาง");
 ...
 try {
                ...
                String file ="C:\\\\Users\\\\Home\\\\Documents\\\\NetBeansProjects\\\\Rubber1\\\\src\\\\report\\\\saleout.jrxml";
                Map m = new HashMap();
                m.put("Saleid", amount);
                JasperPrint  show = JasperFillManager.fillReport(file, m,c);
                JasperViewer jv = new JasperViewer(show,false);
                jv.setVisible(true);
                } catch (JRException ex) {
                Logger.getLogger(report_scraps.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(report_scraps.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new report_scraps().setVisible(true);
            }
        });
}

 ...
 * @author Home
 */
public class report_netsale extends javax.swing.JFrame {
DefaultTableModel model=new DefaultTableModel();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("รายงานกำไรขาดทุน");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(report_netsale.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new report_netsale().setVisible(true);
            }
        });
}

 ...
 * @author Home
 */
public class report_latex extends javax.swing.JFrame {
DefaultTableModel model=new DefaultTableModel();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("รายงานซื้อน้ำยาง");
 ...
 try {
               ...
               /* try {
                ...
                Logger.getLogger(report_latex.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(report_latex.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new report_latex().setVisible(true);
            }
        });
}

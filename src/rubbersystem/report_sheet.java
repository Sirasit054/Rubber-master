 ...
 * @author Home
 */
public class report_sheet extends javax.swing.JFrame {
DefaultTableModel model=new DefaultTableModel();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("รอบขายยาง");

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
        jLabel3.setText("รายงานการซื้อยางแผ่น");
 ...
 try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(report_sheet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new report_sheet().setVisible(true);
            }
        });
}
